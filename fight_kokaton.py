...
class Beam:
    ...
    def __init__(self, bird:"Bird"):
        ...
        self.rct.centerx = bird.rct.centerx + (bird.rct.left -bird.rct.right) * self.vx /5  #    ビームの中心横座標
        self.rct.centery = bird.rct.centery + (bird.rct.top -bird.rct.bottom) * self.vy /5  # ビームの中心縦座標
